...
//		s.setField(1,4,9);
//		s.setField(1,5,8);
//		for(int x = 0; x<s.getGame().length;x++) {
//			for(int y = 0; y<s.getGame().length;y++) {
//				System.out.print(s.getField(x, y));
//			}
//			System.out.println();
//		}
//		assertEquals(9,s.getField(1,4));
//		assertEquals(0,s.getField(1,5));
//		assertEquals(0,s.getField(4,1));
////		assertEquals(0,s.getField(4,1));
////		assertEquals(0,s.getField(4,1));
////		assertEquals(0,s.getField(4,1));
	}
